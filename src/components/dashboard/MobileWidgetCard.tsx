...
export const MobileWidgetCard = memo(function MobileWidgetCard({
  ...
  return (
    <button
      onClick={onExpand}
      className="flex-shrink-0 w-32 h-36 border border-primary/40 bg-card/80 rounded-lg p-3 flex flex-col items-center justify-between transition-all active:scale-95 hover:border-primary hover:bg-primary/5"
